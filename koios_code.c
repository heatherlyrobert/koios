...
CODE_main          (void)
{
   ...
   fprintf (my.file_code, "   printf(\"   --none        = just returns a rc\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --test        = one line of summary statistics\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --scrp        = script level statistics only\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --cond        = condition level statistics only\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --step        = step header level statistics only\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --full        = full detail\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --loud        = full detail\\n\");\n");
   fprintf (my.file_code, "   printf(\"   #---(information)--------------#\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --scrps       = script level statistics only\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --conds       = condition level statistics only\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --steps       = step header level statistics only\\n\");\n");
   fprintf (my.file_code, "   printf(\"   --stats       = display conversion statistics\\n\");\n");
   ...
   fprintf (my.file_code, "      else if (strcmp (a, \"--none\"      )  == 0)      v = 0;\n");
   fprintf (my.file_code, "      else if (strcmp (a, \"--test\"      )  == 0)      v = 1;\n");
   ...
   fprintf (my.file_code, "      else if (strcmp (a, \"--full\"      )  == 0)      v = 5;\n");
   fprintf (my.file_code, "      else if (strcmp (a, \"--loud\"      )  == 0)      v = 5;\n");
   fprintf (my.file_code, "      /*---(information)------------------*/\n");
   fprintf (my.file_code, "      else if (strcmp (a, \"--scrps\"     )  == 0)    { g_exec = 0; v = 2; }\n");
   fprintf (my.file_code, "      else if (strcmp (a, \"--conds\"     )  == 0)    { g_exec = 0; v = 3; }\n");
   fprintf (my.file_code, "      else if (strcmp (a, \"--steps\"     )  == 0)    { g_exec = 0; v = 4; }\n");
   fprintf (my.file_code, "      else if (strcmp (a, \"--stats\"     )  == 0)      UNIT_stats ();\n");
