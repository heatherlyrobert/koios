...
CODE_main          (void)
{
   ...
   fprintf (my.file_code, "   printf(\"   @@quiet, @q   = just returns a rc\\n\");\n");
   fprintf (my.file_code, "   printf(\"   @@test,  @t   = one line of summary statistics\\n\");\n");
   ...
   fprintf (my.file_code, "   printf(\"   @@full,  @f   = full detail\\n\");\n");
   fprintf (my.file_code, "   printf(\"   @@help,  @h   = usage information\\n\");\n");
   fprintf (my.file_code, "   printf(\"   <nn>          = only run script <nn>\\n\");\n");
   fprintf (my.file_code, "   printf(\"   <nnn>         = only show detail on condition <nnn>\\n\");\n");
   ...
   fprintf (my.file_code, "      else if (strcmp(a, \"--all\")      == 0)   ;;\n");
