...
CONV_header        (void)
{
   /*---(output)-------------------------*/
   fprintf (my.file_conv, "\n\n\n");
   fprintf (my.file_conv, "#23456789-12  123  123456789-123456789-123456789-12345  123456789-123456789-123456  123456789-123456789-123456789-123456789-123456789-123456789-123456789-  123456789-  123456789-123456789-123456789-123456789-123456789-123456789-123456789-123456789-123456789-123456789-  -  123456789-123456789- \n");
...
{
   CONV_header ();
   fprintf (my.file_conv, "PREP          %3s  %-65.65s  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   - - - - -   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc);
   return 0;
}
...
CONV_incl          (void)
{
   fprintf (my.file_conv, "   incl       %3s  %-35.35s  %-26.26s  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   - - - - -   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc, my.meth);
   return 0;
}
...
CONV_scrp          (void)
{
   ...
   /*---(output)-------------------------*/
   CONV_header ();
   fprintf (my.file_conv, "SCRP          %3s  %-65.65s  %-70.70s  ((%02d.---))  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc, my.meth, my.nscrp);
   /*---(complete)-----------------------*/
   return 0;
}
...
CONV_sect          (void)
{
   ...
   /*---(output)-------------------------*/
   CONV_header ();
   fprintf (my.file_conv, "SECT          %3s  %-65.65s  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   - - - - -   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc);
   /*---(complete)-----------------------*/
   return 0;
}
...
CONV_shared        (void)
{
   ...
   /*---(output)-------------------------*/
   CONV_header ();
   fprintf (my.file_conv, "SHARED        %3s  %-65.65s  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   ((%c%c.---))  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc, s_shared, s_shared);
   /*---(complete)-----------------------*/
   return 0;
}
...
CONV_group         (void)
{
   /*---(output)-------------------------*/
   fprintf (my.file_conv, "\n");
   fprintf (my.file_conv, "   GROUP      %3s  %-65.65s  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   - - - - -   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc);
   /*---(complete)-----------------------*/
   return 0;
}
...
CONV_cond          (void)
{
   ...
   fprintf (my.file_conv, "\n");
   if (s_shared == '-') {
      fprintf (my.file_conv, "   COND       %3s  %-65.65s  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   ((%02d.%03d))  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc, my.nscrp, my.ncond);
   } else {
      fprintf (my.file_conv, "   COND       %3s  %-65.65s  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -   ((%c%c.%03d))  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  \n", "v21", my.desc, s_shared, s_shared, my.ncond);
   }
   /*---(complete)-----------------------*/
   return 0;
}
...
CONV_exec          (void)
{
   fprintf (my.file_conv, "     %-4.4s     %3s  %-35.35s  %-26.26s  %-70s  %-10.10s  %-100s ", my.verb, "v21", my.desc, my.meth, my.args, my.test, my.expe);
   if (strcmp (my.retn, "") == 0)  fprintf (my.file_conv, "\n"); 
   else                            fprintf (my.file_conv, " %c  %-26.26s \n", my.type, my.retn); 
   return 0;
}
